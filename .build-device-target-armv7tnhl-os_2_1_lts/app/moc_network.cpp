...
#include "../../platforms/syberos/com/syberos/api/src/network.h"
...
const QMetaObject Network::staticMetaObject = {
    { &NativeSdkHandlerBase::staticMetaObject, qt_meta_stringdata_Network.data,
