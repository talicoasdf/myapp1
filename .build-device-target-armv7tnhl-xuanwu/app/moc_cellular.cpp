...
#include "../../platforms/syberos/com/syberos/api/src/cellular.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Cellular_t, stringdata) + ofs \
...
void Cellular::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::CreateInstance) {
        switch (_id) {
        case 0: { Cellular *_r = new Cellular();
...
const QMetaObject Cellular::staticMetaObject = {
    { &NativeSdkHandlerBase::staticMetaObject, qt_meta_stringdata_Cellular.data,
      qt_meta_data_Cellular,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Cellular.stringdata))
        return static_cast<void*>(const_cast< Cellular*>(this));
