...
#include "../../platforms/syberos/com/syberos/api/src/framework/devtools/devtools.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DevTools_t, stringdata) + ofs \
...
void DevTools::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::CreateInstance) {
        ...
        DevTools *_t = static_cast<DevTools *>(_o);
        switch (_id) {
...
const QMetaObject DevTools::staticMetaObject = {
    { &NativeSdkHandlerBase::staticMetaObject, qt_meta_stringdata_DevTools.data,
      qt_meta_data_DevTools,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DevTools.stringdata))
        return static_cast<void*>(const_cast< DevTools*>(this));
