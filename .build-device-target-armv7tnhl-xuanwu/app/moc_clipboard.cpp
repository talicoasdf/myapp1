...
#include "../../platforms/syberos/com/syberos/api/src/clipboard.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Clipboard_t, stringdata) + ofs \
...
const QMetaObject Clipboard::staticMetaObject = {
    { &NativeSdkHandlerBase::staticMetaObject, qt_meta_stringdata_Clipboard.data,
      qt_meta_data_Clipboard,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Clipboard.stringdata))
