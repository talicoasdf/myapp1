...
#include "../../platforms/syberos/com/syberos/api/src/framework/nativesdkhandlerbase.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NativeSdkHandlerBase_t, stringdata) + ofs \
...
QT_MOC_LITERAL(12, 112, 10)
    ...
    "NativeSdkHandlerBase\0success\0\0responseID\0"
...
void NativeSdkHandlerBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NativeSdkHandlerBase::success)) {
                *result = 0;
            }
        }
        {
        ...
        {
            typedef void (NativeSdkHandlerBase::*_t)(QString , QVariant );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NativeSdkHandlerBase::subscribe)) {
                *result = 3;
            }
        }
    }
...
const QMetaObject NativeSdkHandlerBase::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NativeSdkHandlerBase.data,
      qt_meta_data_NativeSdkHandlerBase,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NativeSdkHandlerBase.stringdata))
...
// SIGNAL 0
void NativeSdkHandlerBase::success(long _t1, QVariant _t2)
{
...
// SIGNAL 3
void NativeSdkHandlerBase::subscribe(QString _t1, QVariant _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
