...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_App_Workspace_t, stringdata) + ofs \
...
const QMetaObject App_Workspace::staticMetaObject = {
    { &CWorkspace::staticMetaObject, qt_meta_stringdata_App_Workspace.data,
      qt_meta_data_App_Workspace,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_App_Workspace.stringdata))
        return static_cast<void*>(const_cast< App_Workspace*>(this));
